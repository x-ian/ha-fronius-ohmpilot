...
- **Repository:** /x-ian//fronius_ohmpilot

**Key directories:**

- `custom_components/fronius_ohmpilot/` - Main integration code
...
- Integration logs: `custom_components.fronius_ohmpilot: debug` in `config/configuration.yaml`
...
- **Domain:** `fronius_ohmpilot`
- **Title:** Fronius Ohmpilot
- **Class prefix:** `FroniusOhmpilot`

**When creating new files:**

- Use the domain `fronius_ohmpilot` for all DOMAIN references
- Prefix all integration-specific classes with `FroniusOhmpilot`
- Use "Fronius Ohmpilot" as the display title
...
- Inherit from platform base + `FroniusOhmpilotEntity`
...
- `tests/` mirrors `custom_components/fronius_ohmpilot/` structure
