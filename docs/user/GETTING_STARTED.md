# Getting Started with Fronius Ohmpilot

This guide will help you install and set up the Fronius Ohmpilot custom integration for Home Assistant.
...
5. Add this repository URL: `https://github.com//x-ian//fronius_ohmpilot`
6. Set category to "Integration"
7. Click "Add"
8. Find "Fronius Ohmpilot" in the integration list
9. Click "Download"
10. Restart Home Assistant

### Manual Installation

1. Download the latest release from the [releases page](https://github.com//x-ian//fronius_ohmpilot/releases)
2. Extract the `fronius_ohmpilot` folder from the archive
3. Copy it to `custom_components/fronius_ohmpilot/` in your Home Assistant configuration directory
...
4. Select entities from "Fronius Ohmpilot"
...
- Report issues at [GitHub Issues](https://github.com//x-ian//fronius_ohmpilot/issues)

## Support

For help and discussion:

- [GitHub Discussions](https://github.com//x-ian//fronius_ohmpilot/discussions)
